...
var AppComponent = /** @class */ (function () {
    function AppComponent(movieProvider) {
        this.movieProvider = movieProvider;
        this.title = 'dstv-movies';
    }
    AppComponent.prototype.ngOnInit = function () {
        this.loadMovies();
    };
    AppComponent.prototype.loadMovies = function () {
        var _this = this;
        this.loading = true;
        this.movieProvider.getAllMovies().subscribe(function (data) {
            _this.moviesData = data.components[1].items;
            _this.loading = false;
        });
    };
...
var MoviesService = /** @class */ (function () {
    ...
    MoviesService.prototype.getAllMovies = function () {
        return this.http.get(this.endpoint).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(this.extractData));
    };
...
module.exports = __webpack_require__(/*! C:\work\dstv-movies\src\main.ts */"./src/main.ts");
